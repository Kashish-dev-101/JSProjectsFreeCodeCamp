...
const surpriseMeBtn = document.querySelector(".random-btn");
console.log(surpriseMeBtn);
...
const renderdetails = (item) => {
  ...
  jobTitle.textContent = reviews[currentItem].job;
...
surpriseMeBtn.addEventListener("click", () => {
  ...
  const randomNumber = Math.floor(Math.random() * reviews.length); // generating a random number
